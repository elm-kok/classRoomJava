...
public class TestRaceManager {
	...
	public void testGetWinner() {
		...
		//System.out.println(testRaceManager.getWinner()+" "+targetWalker.getName());
		...
		while (targetWalker.getPosition() < 10000)
			targetWalker.move();
		testRaceManager = new RaceManager(currentTestWalkers);
		//System.out.println(testRaceManager.getWinner().getName()+" "+currentTestWalkers.get(0).getName());
